...
<script>
    // Add click handler for post details
    document.addEventListener('DOMContentLoaded', function() {
        // Make posts clickable (excluding action buttons)
        ...
        // Comment button specific handler
        document.querySelectorAll('.comment-btn').forEach(btn => {
            btn.addEventListener('click', function(e) {
                e.stopPropagation();
                const postId = this.dataset.postId;
                if (postId) {
                    // Set flag to focus comment box when page loads
